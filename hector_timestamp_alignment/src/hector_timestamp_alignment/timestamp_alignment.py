...
class TimestampAlignment:
    def __init__(self, verbose):
        self.imu_sub = rospy.Subscriber("/imu/data_original", sensor_msgs.msg.Imu, self.imu_cb)
        self.imu_aligned_pub = rospy.Publisher("/imu/data", sensor_msgs.msg.Imu, queue_size=10)
